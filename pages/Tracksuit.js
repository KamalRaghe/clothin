...
if(LastHalf[0] === arr[arr.length-1]){
 ...
 console.log(arr[arr.length-1],LastHalf[0],LastHalf)
  ...
  return (
    <div>
      <div className="center" style={{height:"100vh",border:"5px solid black",flexWrap:"wrap"}} >
        {arr.map(pic=>{
          return( 
          <div key={pic}  className="center column" style={{border:'1px solid black',width:'50px',margin:"10px",height:"50px"}}>
